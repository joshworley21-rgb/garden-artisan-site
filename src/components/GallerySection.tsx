...
const sourceImages = [
  ...
  { key: 'jw-g2', alt: 'Cottage-style border of echinacea, salvia and achillea in a gravel garden in front of a timber cart lodge' },
  ...
  { key: 'jw-g6', alt: 'Newly planted border edged with granite setts beside a gravel path, with a multi-stem birch against a new fence' },
