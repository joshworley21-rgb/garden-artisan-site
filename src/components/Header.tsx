...
const Header = () => {
  ...
  // The header shrinks once the page has moved. A scroll listener would fire on
  // every frame to answer a question that changes twice a session, so the work
  // is handed to the browser instead: a marker sits 50px down the document and
  // the observer reports when it leaves the top of the viewport.
  useEffect(() => {
